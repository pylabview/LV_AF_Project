...
<Library LVVersion="23008000">
	...
	<Item Name="Class" Type="Folder">
		<Item Name="Error_Emgime_Class.lvclass" Type="LVClass" URL="../Error_Emgime_Class.lvclass"/>
	</Item>
	<Item Name="Messages" Type="Folder">
		<Item Name="Core Actor - Send Actor Message Msg.lvclass" Type="LVClass" URL="../Error_ENgine_Class Messages/Core Actor - Send Actor Message Msg/Core Actor - Send Actor Message Msg.lvclass"/>
	</Item>
</Library>
