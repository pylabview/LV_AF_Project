...
<Library LVVersion="23008000">
	...
	<Item Name="Class" Type="Folder">
		<Item Name="Message_Distributor_Class.lvclass" Type="LVClass" URL="../Message_Distributor_Class.lvclass"/>
	</Item>
	<Item Name="Messages" Type="Folder">
		<Item Name="Core Actor - Send Actor Message Msg.lvclass" Type="LVClass" URL="../Message_Distributor_Class Messages/Core Actor - Send Actor Message Msg/Core Actor - Send Actor Message Msg.lvclass"/>
		<Item Name="Distributor - SEND - Triggered Event Msg.lvclass" Type="LVClass" URL="../Distributor_Class Messages/Distributor - SEND - Triggered Event Msg/Distributor - SEND - Triggered Event Msg.lvclass"/>
	</Item>
</Library>
