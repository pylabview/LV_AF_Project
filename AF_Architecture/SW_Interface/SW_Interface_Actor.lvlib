...
<Library LVVersion="23008000">
	...
	<Item Name="Class" Type="Folder">
		<Item Name="SW_Interface_Class.lvclass" Type="LVClass" URL="../SW_Interface_Class.lvclass"/>
	</Item>
	<Item Name="Messages" Type="Folder">
		<Item Name="Core Actor - Send Actor Message Msg.lvclass" Type="LVClass" URL="../SW_Interface_Class Messages/Core Actor - Send Actor Message Msg/Core Actor - Send Actor Message Msg.lvclass"/>
	</Item>
</Library>
